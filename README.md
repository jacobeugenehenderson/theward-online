...
| §04 How It Comes Together | the sources table's own chapter, and it has been three things in one day: the second half of §The Slab, a run of headings inside §Bring It Somewhere, and now a chapter. ⛔ **No `<h2>`** — the plate says *How It Comes Together* and the heading said *Where a Ward Comes From*, which is the same sentence twice in two type sizes. ⚠️ **The instruments paragraph here is the page's only remaining mention of the Surveyor, Arborist, Meteorologist and Designer**, and it is also the most technical thing left on the site — the one paragraph a reader has to take on trust |
